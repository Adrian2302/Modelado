...
a.  Esto se da porque se conforman relaciones entre secuencias de varios
    ...
    de los pokemons.
b.  Con n = 3 y semilla de 42069 se genera el nombre "star".
    Con n = 1 y semilla de 3828 se genera el nombre "sshalitrglef".
...
if __name__ == "__main__":
    ...
    word5 = generate_word(model1, 3828)
    ...
    print(result2)
    print(result3)
    print("\nPregunta 8a: model(n=3), seed=42069, palabra: ", word4)
    print("Pregunta 8b: model(n=3), seed=3828, palabra: ", word5)
